...
This folder contains the Kaggle notebook set for **llamatelemetry v0.1.0**.
...
| # | Notebook | Focus |
|---|----------|-------|
| 01 | `01-quickstart-llamatelemetry-v0-1-0-e1.ipynb` | Quickstart: install, GPU check, load model, run inference |
| 02 | `02-llama-server-setup-llamatelemetry-v0-1-0-e1.ipynb` | ServerManager setup + /health /props /slots /metrics |
| 03 | `03-multi-gpu-inference-llamatelemetry-v0-1-0-e1.ipynb` | Multi-GPU config (SplitMode, NCCLConfig, split_gpu_session) |
| 04 | `04-gguf-quantization-llamatelemetry-v0-1-0-e1.ipynb` | GGUF reports, suitability checks, quantization matrix |
| 05 | `05-unsloth-integration-llamatelemetry-v0-1-0-e1.ipynb` | Unsloth fine-tune + GGUF export workflow |
| 06 | `06-split-gpu-graphistry-llamatelemetry-v0-1-0-e1.ipynb` | Split GPU session + Graphistry knowledge graph basics |
| 07 | `07-knowledge-graph-extraction-graphistry-v0-1-0-e1.ipynb` | Knowledge graph builder with entities and relationships |
